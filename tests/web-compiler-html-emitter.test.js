...
describe('web-compiler html emitter', () => {
    ...
    test('renders repeated service_card items using collection mapping and child_mappings', () => {
        ...
        siteDef.pages[0].content = {
            title: 'Homepage',
            service_cards: [
                { title: 'Bins and recycling', summary: 'Collection days and missed bins.', url: '/bins', cta_label: '→' },
                { title: 'Council tax', summary: 'Pay, view or report changes.', url: '/council-tax', cta_label: '→' },
            ],
        };
        ...
        const templateRegistry = {
            ...
            templates: [{
                ...
                child_mappings: [
                    ...
                    { target_component: 'service_card', source_field: 'item.cta_label', target_slot: 'cta_label' },
                ],
            }],
        };
        ...
        expect(html).toContain('c-service-card__cta_label');
        expect(html).not.toContain('c-service-card__collection');
        expect(html).not.toContain('c-result-item');
    });
