 ...
 * Implements SOAP API calls to Gloucester City Council's ModernGov system
 */
...
class ModernGovClient {
     ...
     */
    async getCommittees() {
        const parsed = await this._callSoap('GetCommittees', '');
     ...
     */
    async getCouncillorsByWard() {
        const parsed = await this._callSoap('GetCouncillorsByWard', '');
     ...
     */
    async getCouncillorsByWardId(wardId) {
        const bodyContent = `<lWardId>${wardId}</lWardId>`;
        const parsed = await this._callSoap('GetCouncillorsByWardId', bodyContent);
    ...
    async getMeetings(committeeId, fromDate, toDate) {
        ...
        const parsed = await this._callSoap('GetMeetings', bodyContent);
    ...
    async getMeeting(meetingId) {
        ...
        const parsed = await this._callSoap('GetMeeting', bodyContent);
    ...
    async getAttachment(attachmentId) {
        ...
        const parsed = await this._callSoap('GetAttachment', bodyContent);
