...
const { buildDocumentChunkIndex, setCachedIndex, getCachedIndex } = require('./document-chunker');
...
async function callTool(name, args, context) {
    ...
    switch (name) {
        ...
        case 'harvest_documents': {
            ...
            // Build chunk index from harvested documents
            const chunks = buildDocumentChunkIndex(harvest.documents);
            setCachedIndex(chunks);
            resetSearchCache();
            ...
            return {
                ...
                note: 'Document index built. Use search_documents to search across all harvested content.'
            };
        }
