...
const TOOLS = [
    {
        ...
        description: `Lists all available Gloucestershire councils that can be queried through this MCP server.

Use this tool first to discover which councils are available and their exact names. The council names returned by this tool are the exact strings required for the council_name parameter in other tools.

Returns for each council:
- Exact name (use this string in other tool calls)
