...
💡 TIP: Use get_meeting_details first to find attachment IDs in the linkeddocuments field.`,
...

    {
        ...
        description: `Parses a committee report PDF and returns only the recommendations section.

Usage example: get_report_recommendations(url='https://democracy.gloucester.gov.uk/mgConvert2PDF.aspx?ID=12345')

Designed for focused extraction when you only need formal recommendations/resolutions from a report. Use get_attachment first to obtain the report URL.`,
        inputSchema: {
            type: 'object',
            properties: {
                url: {
