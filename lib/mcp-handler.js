...
const TOOLS = [
    ...
    },
    {
        ...
        description: 'Fetches and parses committee documents (PDFs) to extract structured information including reasons for reports, recommendations, questions, and motions. Use after get_attachment to analyze document content.',
        inputSchema: {
            type: 'object',
            properties: {
                url: {
