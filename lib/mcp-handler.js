            ...
            return {
                ...
                result: {
                    ...
                    serverInfo: {
                        name: 'moderngov-mcp',
                        version: '1.0.0',
                        description: 'Gloucester City Council ModernGov API - Official Democratic Records',
                        ...getDateContext(),
                        instructions: `IMPORTANT: This MCP server provides official statutory records of democratic decision-making for Gloucester City Council.

When using data from these tools:
1. QUOTE VERBATIM: Committee recommendations, decisions, resolutions, and motions must be quoted exactly - never paraphrase
2. ALWAYS LINK SOURCES: Include source_url or web_page links from responses
3. SEPARATE INTERPRETATION: Clearly distinguish official record from your explanations
4. USE CORRECT DATES: Today is ${new Date().toLocaleDateString('en-GB', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}. Do not assume or guess meeting dates.
