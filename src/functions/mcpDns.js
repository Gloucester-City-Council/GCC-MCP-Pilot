...
// Every hostname here has been verified to resolve in public DNS.
// ccTLDs without a working public RDAP server (jp, hk, mx, it, ie, th)
// are intentionally omitted — they fall through to the IANA bootstrap
// and return a clean "no service registered" error if absent there too.
const RDAP_CCTLD_OVERRIDES = {
    ...
    'au':       'https://rdap.au',
    'com.au':   'https://rdap.au',
    'net.au':   'https://rdap.au',
    'org.au':   'https://rdap.au',
    'nz':       'https://rdap.nz',
    'co.nz':    'https://rdap.nz',
    'net.nz':   'https://rdap.nz',
    'org.nz':   'https://rdap.nz',
    'cn':       'https://rdap.cn',
    'kr':       'https://rdap.kr',
