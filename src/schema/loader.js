 ...
 * Loads four v2.4 documents (facts, rules, taxonomy, results) from schemas/CouncilTax/
...
/**
 * Schema file manifest - the four v2.4 documents
 */
const SCHEMA_FILES = {
    facts: 'council_tax_facts.v2.4.json',
    rules: 'council_tax_rules.v2.4.json',
    taxonomy: 'council_tax_taxonomy.v2.4.json',
    results: 'council_tax_results.v2.4.json'
};
